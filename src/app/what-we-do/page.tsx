...
export const metadata: Metadata = {
  title: "What we do — adnova",
  description: "How an adnova campaign actually gets made, from brief to launch.",
};
    ...
    <>
        ...
        <div>
          {processSteps.map((step, i) => (
            <Reveal
              key={step.index}
              delay={i * 0.06}
              className={`flex flex-col gap-3 py-9 sm:flex-row sm:items-start sm:gap-10 ${
                i !== 0 ? "border-t border-hair" : "pt-0"
              }`}
            >
              <span className="font-mono w-[52px] shrink-0 text-2xl font-medium text-accent">
                {step.index}
              </span>
      ...
      <section className="mx-auto max-w-[1200px] px-6 pb-[90px] lg:px-12">
        <SectionHead
          ...
          description="The disciplines we work across on any given campaign."
        />
